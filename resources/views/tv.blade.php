...
<body class="bg-background overflow-hidden text-foreground tv-body">
    ...
    <div id="tv-container"
        class="bg-background p-2 lg:p-3 md:px-4 md:py-4 w-screen overflow-hidden text-foreground tv-container min-h-svh landscape:h-svh landscape:overflow-hidden portrait:h-auto portrait:overflow-visible">
        <div class="gap-4 grid tv-grid grid-cols-[2fr_1fr_1fr] grid-rows-6 h-full landscape:h-full portrait:h-auto portrait:min-h-svh">
            <section class="min-h-0 tv-panel-live col-start-1 row-span-full portrait:row-auto">
            ...
            <section class="bg-card shadow-sm border border-border rounded-3xl min-h-0 tv-panel-recent col-start-2 row-span-full portrait:row-auto">
            ...
            <section class="tv-panel-right min-h-0 col-start-3 row-span-full portrait:row-auto">
