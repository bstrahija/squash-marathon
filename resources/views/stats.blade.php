<x-layouts.public-page title="Squash Marathon - Statistika"
    ...
    <section class="scroll-mt-24">
        <div class="m-6 flex items-center justify-between gap-4">
            <h1 class="font-display text-foreground text-3xl font-semibold">Statistika</h1>
        </div>

        <livewire:stats.leaderboard />
    </section>
