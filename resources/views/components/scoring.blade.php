<section class="rounded-3xl border border-border bg-card p-6 shadow-sm">
    <div class="flex flex-wrap items-end justify-between gap-4">
        ...
        <p class="text-xs text-muted-foreground">Svaka završena igra donosi bodove i vrijeme.</p>
    </div>
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div class="relative rounded-2xl border border-border/70 bg-background/70 p-6">
            ...
            <div
                class="mt-6 flex flex-wrap items-center gap-3 rounded-2xl border border-border/70 bg-card px-4 py-3 text-xs text-muted-foreground">
                <span
                    class="rounded-full bg-amber-400/20 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-300">Vremenska
                    crta</span>
                <span>Primjer: 19:45 i gotovo.</span>
            </div>
        </div>
